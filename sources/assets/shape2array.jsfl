...
var ptArray = [];
var doneEdge = [];
var exportString = "";//'var shapes:Array = new Array ();\n';
...
//Custom things for mushcontagion
exportString += '			colorsLists.push( ['+colors.join(", ").replace(/#/gi, "0x")+'] );\n';
exportString += '			eyes.push(shapes);';
