package com.muxxu.mush.contaminator {
	 ...
	 * @date 7 janv. 2012;
	 */
	public class ContaminatorLoader extends MovieClip {
		 ...
		 * *********** */
		/**
		 * Creates an instance of <code>ContaminatorLoader</code>.
		 */
		public function ContaminatorLoader() {
			initialize();
		}
...
//			stage.scaleMode	= StageScaleMode.NO_SCALE;
			...
			Config.addVariable("key", "3deb94ec");
		...
		private function launch():void {
			// on frame 2
			var mainClass:Class = Class(getDefinitionByName("com.muxxu.mush.contaminator.Contaminator"));
			if(mainClass && !_error) {
