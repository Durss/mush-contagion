package com.muxxu.mush.contaminator.components {
	...
	public class Fog extends Sprite {
		...
		private function initialize(event:Event):void {
			...
			_p1 = new Point();
			_p2 = new Point();
			_bmd = new BitmapData(400, 150, true, 0);
			...
			_maskMc.graphics.beginGradientFill("linear", [0,0], [0,1], [0,0xff], m, SpreadMethod.PAD, InterpolationMethod.RGB);
			_maskMc.graphics.drawRect(0, 0, 100, 100);
...
//			_holder.y = stage.stageHeight - _holder.height;
		...
		private function enterFrameHandler(event:Event):void {
			...
			_bmd.perlinNoise(300, 300, 2, _seed, false, false, BitmapDataChannel.ALPHA, true, [_p1, _p2]);
			_bmd.threshold(_bmd, _bmd.rect, new Point(), "<", 0x303030, 0, 0xffffff, true);
			_bmd.applyFilter(_bmd, _bmd.rect, new Point(), new BlurFilter(20,20,3));
